    ...
    <>
      <div className="forManager mx-auto">
        <div className="row mx-auto" style={{ width: "900px" }}>
          <div className="col-4" id="ManagerDiv1">
            ...
            <div className="assigned my-3">
              <div className="row" id="taskcontents">
                ...
                <div className="col-4">
                  {" "}
                  <Button onClick={handleOpen} id="buttonstyle">
                    <AddBoxIcon
                      style={{
                        textAlign: "right",
                        margin: "auto",
          ...
          <div className="col-4" id="ManagerDiv2">
            ...
            <div className="assigned my-3">
              ...
              <div className="row" id="taskcontents">
                ...
                <div
                  className="col-4"
                  style={{ textAlign: "right", curser: "pointer" }}
                >
                  <EditIcon />
                </div>
              </div>
      ...
      >
        <Box sx={style}>
          ...
          <textarea
            ...
            style={{ width: "90%" }}
          ></textarea>
          <button style={{ backgroundColor: "salmon", borderWidth: "1px" }}>
            Save
          </button>
        </Box>
      </Modal>
